...
void ISCBDIV::Init(vector<float> param1, unsigned int param2, unsigned int param3, unsigned int param4, float param5, string param6)
{
    iProb = param1;
    depthSync = param2;
    depth = param3;
    ...
    skewedSyncInst.Init(iProb, depthSync, wSize, thdBias,"skewedSyncInst");
...
void ISCBDIV::Calc(vector<char> param1, vector<unsigned int> param2)
{
    iBit = param1;
    randNum = param2;
    ...
    // *****************************************************************************
    skewedSyncInst.Calc(iBit);
    cordivKernelInst.Calc(skewedSyncInst.OutBit(),randNum);
...
vector<char> ISCBDIV::OutBit()
{
    ...
    vector<float> ISCBDIV::TheoProb()
    {
        return theoProb;
    }

    vector<float> ISCBDIV::WBias()
    {
        return wBias;
    }
